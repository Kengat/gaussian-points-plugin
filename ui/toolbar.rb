module GaussianPoints
  module UIparts
    module ToolbarManager
      ...
      cmd_clip.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_24.png')
      cmd_clip.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_32.png')
      ...
      cmd_clip_move.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_move_24.png')
      cmd_clip_move.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_move_32.png')
      ...
      cmd_clip_hide.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_hide_24.png')
      cmd_clip_hide.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_hide_32.png')
      ...
      cmd_clip_reset.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_reset_24.png')
      cmd_clip_reset.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_reset_32.png')
      ...
      cmd_clip_delete.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_delete_24.png')
      cmd_clip_delete.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'clip_delete_32.png')
      ...
      cmd_select.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'sel_24.png')
      cmd_select.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'sel_32.png')
      ...
      cmd_move.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'move_24.png')
      cmd_move.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'move_32.png')
        cmd_move.tooltip = 'Move Tool'
        cmd_move.status_bar_text = 'Selects a point cloud or gaussian splat set and edits it with the shared gizmo.'

        cmd_move_reset = UI::Command.new('Reset Move Transform') {
          MoveToolManager.reset_selected_item_transform
        }
      cmd_move_reset.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'move_reset_24.png')
      cmd_move_reset.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'move_reset_32.png')
        cmd_move_reset.set_validation_proc { MoveToolManager.selected? ? MF_ENABLED : MF_GRAYED }
        cmd_move_reset.tooltip = 'Reset Move Transform'
        cmd_move_reset.status_bar_text = 'Resets the selected object back to its imported transform.'
        ...
        toolbar.add_item(cmd_move_reset)
      ...
      cmd_hide.small_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'eye_open_24.png')
      cmd_hide.large_icon = File.join(GaussianPoints::PLUGIN_DIR, 'ui', 'icons', 'eye_open_32.png')
