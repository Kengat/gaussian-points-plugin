...
extern "C" {
    ...
    EXPORT void LoadSplatsFromGASP(const char* filename);
    EXPORT void LoadSplatsFromGASPWithUpAxis(const char* filename, int up_axis_mode);
    ...
    EXPORT int LoadSplatObjectFromGASP(const char* object_id, const char* filename, double* out_center_xyz, double* out_half_extents_xyz);
    EXPORT int LoadSplatObjectFromGASPWithUpAxis(const char* object_id, const char* filename, double* out_center_xyz, double* out_half_extents_xyz, int up_axis_mode);
